...
class MultiWindowClickerTest {
    ...
    /** Alphabetical by default: Aria (1), Lenore (2), Zora (3). */
    ...
    class Targets {
        ...
        void skipsTheExcludedWindows() {
            ...
            new Features(api, Map.of("multiclick_exclude", List.of("zora")))
                    .clicker().clickAllWindows(CURSOR);
    ...
    class AttentionReset {
        ...
        void visitsEveryWindowAndReturnsToTheLeader() {
            ...
            new Features(api, Map.of(
                    "window_cycle_order", List.of("Zora", "Lenore", "Aria"),
                    "focus_cooldown", 0))
                    .clicker().resetWindowsAttentionState();

            // Configured order is Zora (3), Lenore (2), Aria (1): visited back to front, then the
            // focus goes back to the leader, Zora — which is where the player was playing.
        ...
        void picksTheLeaderFromTheConfiguredOrder() {
            ...
            // Alphabetical for want of a configured order: the leader is Aria, and the reversal is a
