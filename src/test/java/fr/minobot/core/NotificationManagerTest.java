...
class NotificationManagerTest {
    ...
    private static final String REAL_TOAST = """
            ...
            <text id="1">Bravo - Dofus Retro</text>\
    ...
    void parsesAToastThatCarriesOnlyATitle() {
        final var payload = "<toast><visual><binding><text>Bravo - Dofus</text></binding></visual></toast>";

        assertThat(NotificationManager.parseToast(payload)).contains(new Notification("Bravo - Dofus", ""));
    }
